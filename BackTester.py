...
class DummyDataGenerator:
    ...
    #         historical_data[interval] = await self.instance.get_historical_kline_hour_min(
    #             symbol=symbol,
    #             interval=interval,
...
#     ins_kline_ex = KlineDataExtractor(kline_data=merge_data,
...
if __name__ == "__main__":
    ...
    ins_kline_ex = KlineDataExtractor(kline_data=merge_data, index_data=indices_data, symbols=symbols)
    # data_length = ins_kline_ex.get_data_length()
    data_range = 60 * 24
