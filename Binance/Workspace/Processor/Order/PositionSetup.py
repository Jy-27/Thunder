...
class PositionSetup:
    ...
    async def apply_margin_type(self):
        """
    ...
    async def run_setup(self):
        ...
        await self.apply_leverage()
        await self.apply_margin_type()


if __name__ == "__main__":
    dummy_instance = PositionSetup()
    asyncio.run(dummy_instance.run_setup())
    print("세팅완료")
